...
def upload_new_files_to_gcs(
    ...
    bucket_name: str, 
    gcs_folder: str = "", 
    log_file: str = "../../logs/bucket/customers_uploaded_files.log",
    verbose: bool = True
) -> Dict[str, int]:
    """
...
if __name__ == "__main__":
    try:
        ...
        local_folder = "../../data/retail_db/customers"
        gcs_folder = "customers"  # Pasta lógica no GCS
        log_file = "../../logs/bucket/customers_uploaded_files.log"  # Log local para rastrear uploads

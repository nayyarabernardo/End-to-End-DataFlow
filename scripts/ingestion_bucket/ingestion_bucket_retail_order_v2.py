...
def upload_new_files_to_gcs(
    ...
    bucket_name: str, 
    gcs_folder: str = "", 
    log_file: str = "../../logs/bucket/order_uploaded_files.log",
    verbose: bool = True
) -> Dict[str, int]:
    """
...
if __name__ == "__main__":
    try:
        ...
        local_folder = "../../data/retail_db/order"
        gcs_folder = "order"  # Pasta lógica no GCS
        log_file = "../../logs/bucket/order_uploaded_files.log"  # Log local para rastrear uploads
